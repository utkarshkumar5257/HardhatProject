...
contract SupplyChain_OLD {
    ...
    /********************************************** Supplier Section ******************************************/
    enum packageStatus { at, picked, delivered }
    ...
    function supplyRaw(
        ...
        RawProductDetails[pid].status = packageStatus.at;
    ...
    function loadpacakage(bytes32 pid, uint transportertype, uint receivertype) public {
        ...
        if(transportertype == 1) {
            ...
            RawProductDetails[pid].status = packageStatus.picked;
            ...
            MedicineWtoD[pid].status = packageStatus.picked;
            ...
            MedicineDtoR[pid].status = packageStatus.picked;
    ...
    function rawProductReceived(bytes32 pid) public {
        ...
        RawProductDetails[pid].status = packageStatus.delivered;
    ...
    function newBatch(
        ...
        MedicineBatchDetails[batchID].status = medicineStatus.atcreator;
        if(receivertype == 1){
    ...
    function medicineReceived(bytes32 pid) public {
        ...
        if(UsersDetails[msg.sender].role == roles.wholesaler) {
            ...
            if(MedicineBatchDetails[pid].wholesaler != address(0)){
                MedicineWtoD[pid].status = packageStatus.delivered;
    ...
    ) public
    {
        ...
        MedicineWtoD[BatchID].status = packageStatus.at;
        MedicineWtoD[BatchID].sender = msg.sender;
        MedicineBatchDetails[BatchID].distributer = Receiver;
        MedicineBatchDetails[BatchID].status = medicineStatus.picked4D;
    ...
    ) public
    {
        ...
        MedicineDtoR[BatchID].status = packageStatus.at;
    ...
    function receiveMedicineFormD(
        ...
        MedicineDtoR[BatchID].status = packageStatus.delivered;
        MedicineBatchDetails[BatchID].status = medicineStatus.deliveredatP;
